...
$search_info = $_GET['id'];
$sql = "SELECT * FROM cinema.movie where id = $search_info ";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
?>

<img class ='background_img' src="<?php echo $row['avatar'] ?>" alt="">
<!-- Background-img -->
<div class="background-img">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
                <img class="card-item" src="<?php echo $row['avatar'] ?>" alt="">
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="main-carousel">
                ...
                <div class="sell">
                    ...
                    <img
                        src="https://nocodebuilding.com/wp-content/uploads/2021/03/xem-phim-raya-va-rong-than-cuoi-cung-full-thuyet-minh.jpg">
                </div>
                ...
                <div class="sell">
                    ...
                    <img
                        src="https://static2.vieon.vn/vieplay-image/thumbnail_big_v4/2021/12/01/84wg13sf_1920x1080_bietdoisieuanhhung_1267_712.jpg">
                </div>
                ...
                <div class="sell">
                    ...
                    <img
                        src="https://simg.zalopay.com.vn/zlp-website/assets/phim_chieu_rap_Viet_Nam_moi_nhat_co_gai_tu_qua_khu_995a16d6a7.jpg">
                </div>
